...
<%!
	...
	ResultSet rs;
	int slNo;
	String invNo, invD, reqN,reqD, retN, phNo, mid, proID, proN, cat, pri, purQ, amo, disp, disA, gstA, gstP, net, prodC;
                ...
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblissuetoret where Product_ID='"+prodC+"'");
							slNo = 1;
							while(rs.next()){
