...
<%!
	...
	String reqNo, reqDt[], retN[], retID[], local[], ct[], phNo[], mid[], gstN[];
	...
	<head>
		...
		<script language="javascript">
			function showRetailer(){
				var jreqDt, jretN, jretID, jlocal, jct, jphNo, jmid, jgstN;
				var i, j;
		...
		<script language="javascript">
			...
			function goFind(){
				window.location = "OSP_IssueToRetfc.jsp"
			}
		</script>
	</head>
	<body>
		<section class="Contener">
			...
			<form name="f1" action="OSP_IssueToRets.jsp" method="post">
					...
					<div class="box">
						...
						<div class="row">
							<div class="input_box">
								...
								<select class="tbox" name="cmbReqN" onchange=" showRetailer()">
									<option value="">--select--</option>
									<%
										doConnect();
										try{
											stmtReqN = conn. createStatement();
											rsReqN = stmtReqN.executeQuery("select * from osp_tblretreq");
											while(rsReqN.next()){
