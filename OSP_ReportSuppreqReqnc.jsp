...
<html>
	...
	<body>
		<section class="Contener">
			...
			<form name="f1" action="OSP_ReportSuppreqReqns.jsp" method="post">
			
				<h2>Supplier/Company Requisition [Requisition Number]</h2>
				<div class="Main">
					<div class="box">
						<div class="input_box">
							<label class="lbl">Requisition Number :</label>
							<select name="cmbreqN" class="tbox">
