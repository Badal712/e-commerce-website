...
<%!
	...
	ResultSet rs;
	int slNo;
	String vouN, dt, retN, retID, phNo, mid, payM, ref, bank, amo, retaN;
...
%>
<%
	retaN = request.getParameter("cmbretN");
%>
<html>
	<head>
                ...
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblreceiptvou where Retailer_Name = '"+retaN+"'");
							slNo = 1;
							while(rs.next()){
								vouN = rs.getString("Voucher_Number");
								dt = rs.getString("Voucher_Date");
								retN = rs.getString("Retailer_Name");
								retID = rs.getString("Retailer_ID");
								phNo = rs.getString("Phone_Number");
								mid = rs.getString("E_Mail");
								payM = rs.getString("Payment_Mode");
								ref = rs.getString("Refernce_Number");
