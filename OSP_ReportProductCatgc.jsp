...
<html>
	...
	<body>
		<section class="Contener">
			...
			<form name="f1" action="OSP_ReportProductCatgs.jsp" method="post">
			
				<h2>Product Information [Category]</h2>
				<div class="Main">
					<div class="box">
						<div class="input_box">
							<label class="lbl">Product Category Name :</label>
							<select name="cmbPCN" class="tbox" onchange="productCat()">
								<option value="">--select--</option>
								<%
									doConnect();
									try{
										stmt = conn.createStatement();
										rsPCN = stmt.executeQuery("select * from osp_tblprodcat");
										
										while(rsPCN.next()){
											productCN = rsPCN.getString("Product_Category_Name");
									
								%>
								<option value="<%=productCN%>"><%=productCN%></option>
								<%
										}
									}
									catch(SQLException se){
