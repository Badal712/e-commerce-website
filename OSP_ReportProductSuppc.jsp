...
<html>
	...
	<body>
		<section class="Contener">
			...
			<form name="f1" action="OSP_ReportProductSupps.jsp" method="post">
			
				<h2>Product Information [Supplier Name]</h2>
				<div class="Main">
					<div class="box">
						<div class="input_box">
							<label class="lbl">Supplier Name :</label>
							<select name="cmbSuppN" class="tbox">
								<option value="">--select--</option>
								<%
									doConnect();
									try{
										stmt = conn.createStatement();
										rsSupN = stmt.executeQuery("select * from tblsup");
										
										while(rsSupN.next()){
											suppN = rsSupN.getString("Supplier_Name");
									
								%>
								<option value="<%=suppN%>"><%=suppN%></option>
								<%
										}
									}
									catch(SQLException se){
