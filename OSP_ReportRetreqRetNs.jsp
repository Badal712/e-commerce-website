...
<%!
	...
	ResultSet rs;
	int slNo;
	String reqN, dt, retID, retN, phNo, mid, gst, proC, proN, cat, pri, purQ, amo, retaN;
		...
		<section class="Contener">
            ...
            <div class="subh">
                <center>
					...
					<h2>Retailer Requisition [<%=retaN%>]</h2>
                </center>
            </div>
            <div class="data">
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblretreq where Retailer_Name='"+retaN+"'");
							slNo = 1;
							while(rs.next()){
