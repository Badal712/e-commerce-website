...
<%!
	...
	ResultSet rs;
	int slNo;
	String proC, suppC, suppN, proCat, proCC, proN, unit, purP, mrp, taxS, sto, pto, catg;
...
%>
<%
catg = request.getParameter("cmbPCN");
%>
<html>
	<head>
                ...
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblproduct where Product_Category = '"+catg+"'");
							slNo = 1;
							while(rs.next()){
