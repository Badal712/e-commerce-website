...
<html>
	...
	<body>
		<section class="Contener">
			...
			<form name="f1" action="OSP_ReportIssueToCustMobs.jsp" method="post">
			
				<h2>Issue to Customer [Mobile Number]</h2>
				<div class="Main">
					<div class="box">
						<div class="input_box">
							<label class="lbl">Mobile Number :</label>
							<select name="cmbMob" class="tbox">
								...
								<%
									...
									try{
										...
										while(rs.next()){
											mob = rs.getString("Customer_Number");
