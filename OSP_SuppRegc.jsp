...
%>
<%
	proName = new String[50];
	proCat = new String[50];
	proPrice = new String[50];
	doConnect();
...
<html>
	<head>
		...
		<script language="javascript">
			function goFind(){
				window.location="OSP_SuppRegfc.jsp";
			}
			function supInfo(){
	...
	<body>
		<section class="Contener">
			...
			<form name="f1" class="form" action="OSP_SuppRegs.jsp" method="post">
