...
<%!
	...
	String vouN, vouD[], suppID[], suppN[], phNum[], emid[], gstNum[], payM[], refN[], dt[], bank[], amo[]; 
	String supID, supN[], phNo[], mid[], gstN[];
	int i, vn;
...
<%
	...
	try{
		...
		rsArray = stmtArray.executeQuery("select * from osp_tblpayment");
		i = 0;
...
<html>
	<head>
		<title>Payment Vaucher</title>
		<link rel="stylesheet" href="mystyle.css">
		<script language="javascript">
			function goBack(){
				window.location = "OSP_PaymentVouc.jsp";
			}
			function showPayData(){
				var jvouD, jsuppID, jsuppN, jphNum, jemid, jgstNum, jpayM, jrefN, jdt, jbank, jamo;
				var i, j;
				...
				document.f1.cmbSupID.value = jsuppID[k-1];
				document.f1.txtSupName.value = jsuppN[k-1];
	...
	<body>
		<section class="Contener">
			...
			<form name="f1" action="OSP_PaymentVoufs.jsp" method="post">
					...
					<div class="box">
								...
								<select name="cmbVouN" class="tbox" onchange="showPayData()">
									...
									<%
										...
										try{
											...
											rsVou = stmtVou.executeQuery("select * from osp_tblpayment");
											while(rsVou.next()){
						...
						<div class="row">
							<div class="input_box">
								...
								<select name="cmbSupID" class="tbox" onchange = "showSupp()">
									<option value="">--Select--</option>
									<%
										doConnect();
										try{
											stmtsupp = conn.createStatement();
											rssupp = stmtsupp.executeQuery("select * from tblsup");
											while(rssupp.next()){
												supID = rssupp.getString("Supplier_ID");
									%>
							...
							<div class="input_box">
								...
								<input type="text" name="txtSupName" class="tbox" readonly>
							</div>
						</div>
						<div class="row">
							<div class="input_box">
