...
<%!
	...
	ResultSet rs;
	int slNo;
	String reqN, dt, retID, retN, phNo, mid, gst, proC, proN, cat, pri, purQ, amo, prodC;
...
%>
<%
	prodC = request.getParameter("cmbProC");
%>
<html>
	<head>
		...
		<section class="Contener">
            ...
            <div class="subh">
                <center>
					...
					<h2>Retailer Requisition [<%=prodC%>]</h2>
                </center>
            </div>
            <div class="data">
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblretreq where Product_Code='"+prodC+"'");
							slNo = 1;
							while(rs.next()){
