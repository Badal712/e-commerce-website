...
<%!
	...
	ResultSet rs;
	int slNo;
	String odN, dt, mob, nm, mid, prodC, prodN, cat, pri, ordQ, Amo, proC;
                ...
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblcustorder where Product_Code = '"+proC+"'");
							slNo = 1;
							while(rs.next()){
