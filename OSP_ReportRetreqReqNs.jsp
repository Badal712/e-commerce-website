...
<%!
	...
	ResultSet rs;
	int slNo;
	String reqN, dt, retID, retN, phNo, mid, gst, proC, proN, cat, pri, purQ, amo, requN;
...
%>
<%
	requN = request.getParameter("cmbReqN");
%>
<html>
	<head>
		...
		<section class="Contener">
            ...
            <div class="subh">
                <center>
					...
					<h2>Retailer Requisition [<%=requN%>]</h2>
                </center>
            </div>
            <div class="data">
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblretreq where Requisition_Number='"+requN+"'");
							slNo = 1;
							while(rs.next()){
