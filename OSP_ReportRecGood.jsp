...
<%!
	...
	ResultSet rs;
	int slNo;
	String invNo, invD, reqN,reqD, supN, phNo, mid, proID, proN, cat, pri, purQ, amo, disp, disA, gstA, gstP, net ;
                ...
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblrecgood");
							slNo = 1;
							while(rs.next()){
								...
								purQ = rs.getString("Purchase_Quantity");
