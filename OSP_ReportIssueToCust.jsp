...
<%!
	...
	ResultSet rs;
	int slNo;
	String invNo, invD, ordN, ordD, custN, custNa, mid, proID, proN, cat, pri, purQ, amo, disp, disA, gstA, gstP, net ;
                ...
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblissuetocust");
							slNo = 1;
							while(rs.next()){
