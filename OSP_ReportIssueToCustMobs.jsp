...
<%!
	...
	ResultSet rs;
	int slNo;
	String invNo, invD, ordN, ordD, custN, custNa, mid, proID, proN, cat, pri, purQ, amo, disp, disA, gstA, gstP, net, MobiN ;
...
%>
<%
	MobiN = request.getParameter("cmbMob");
%>
<html>
	<head>
		...
		<section class="Contener">
            ...
            <div class="subh">
                <center>
					...
					<h2>Issue of Goods (Customer) [<%=MobiN%>]</h2>
                </center>
            </div>
            <div class="data">
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblissuetocust where Customer_Number = '"+MobiN+"'");
							slNo = 1;
							while(rs.next()){
								invNo = rs.getString("Invoice_Number");
								invD = rs.getString("Invoice_Date");
								ordN = rs.getString("Order_Number");
								ordD = rs.getString("Order_Date");
								custN = rs.getString("Customer_Number");
								custNa = rs.getString("Customer_Name");
