...
<%!
	...
	ResultSet rs;
	int slNo;
	String reqN, dt, supID, supN, phNo, mid, gst, proC, proN, cat, pri, purQ, amo, reqnNo;
...
%>
<%
	reqnNo = request.getParameter("cmbreqN");
%>
<html>
	<head>
		...
		<section class="Contener">
            ...
            <div class="subh">
                <center>
					...
					<h2>Supplier/Company Requisition [<%=reqnNo%>]</h2>
                </center>
            </div>
            <div class="data">
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblsuppreg where Requisition_Number='"+reqnNo+"'");
							slNo = 1;
							while(rs.next()){
