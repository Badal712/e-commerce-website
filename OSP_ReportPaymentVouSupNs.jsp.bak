...
<%!
	...
	ResultSet rs;
	int slNo;
	String vouN, dt, supID, supN, phNo, mid, payM, ref, bank, amo, suppN;
...
%>
<%
	suppN = request.getParameter("cmbsupN");
%>
<html>
	<head>
                ...
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblpayment where Supplier_Name = '"+suppN+"'");
							slNo = 1;
							while(rs.next()){
