...
<%!
	...
	String vouN, vouD, retN, retID, phNo, mid, gstN, payM, refN, dt, bank, amo;
	...
	<head>
		<%
			...
			try{
				...
				stmt.executeUpdate("insert into osp_tblreceiptvou value('"+vouN+"', '"+vouD+"', '"+retN+"', '"+retID+"', '"+phNo+"', '"+mid+"', '"+gstN+"', '"+payM+"', '"+refN+"', '"+dt+"', '"+bank+"', '"+amo+"')");
				
				//Code for show alert
					
				out.println("<script type='text/javaScript'>");
				out.println("alert("+"'Your data Saved Successfully...'"+");\n");
				out.println("setTimeout(function(){window.location.href='OSP_ReceiptVouc.jsp'},10);");
				out.println("</script>\n");
			}
			catch(SQLException se){
