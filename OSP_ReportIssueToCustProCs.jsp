...
<%!
	...
	ResultSet rs;
	int slNo;
	String invNo, invD, ordN, ordD, custN, custNa, mid, proID, proN, cat, pri, purQ, amo, disp, disA, gstA, gstP, net, proC ;
		...
		<section class="Contener">
            ...
            <div class="subh">
                <center>
					...
					<h2>Issue of Goods (Customer) [<%=proC%>]</h2>
                </center>
            </div>
            <div class="data">
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblissuetocust where Product_ID = '"+proC+"'");
							slNo = 1;
							while(rs.next()){
