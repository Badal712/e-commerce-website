...
<%!
	...
	ResultSet rs;
	int slNo;
	String invNo, invD, reqN,reqD, retN, phNo, mid, proID, proN, cat, pri, purQ, amo, disp, disA, gstA, gstP, net, retaN;
                ...
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblissuetoret where Retailer_Name='"+retaN+"'");
							slNo = 1;
							while(rs.next()){
