...
<%!
	...
	ResultSet rs;
	int slNo;
	String odN, dt, mob, nm, mid, prodC, prodN, cat, pri, ordQ, Amo, mobi;
...
%>
<%
	mobi = request.getParameter("cmbmob");
%>
<html>
	<head>
                ...
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblcustorder where Mobile_Number = '"+mobi+"'");
							slNo = 1;
							while(rs.next()){
