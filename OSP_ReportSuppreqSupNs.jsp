...
<%!
	...
	ResultSet rs;
	int slNo;
	String reqN, dt, supID, supN, phNo, mid, gst, proC, proN, cat, pri, purQ, amo, suppN;
		...
		<section class="Contener">
            ...
            <div class="subh">
                <center>
					...
					<h2>Supplier/Company Requisition [<%=suppN%>]</h2>
                </center>
            </div>
            <div class="data">
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblsuppreg where Supplier_Name = '"+suppN+"'");
							slNo = 1;
							while(rs.next()){
