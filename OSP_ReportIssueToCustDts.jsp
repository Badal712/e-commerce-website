...
<%!
	...
	ResultSet rs;
	int slNo;
	String invNo, invD, ordN, ordD, custN, custNa, mid, proID, proN, cat, pri, purQ, amo, disp, disA, gstA, gstP, net, dt ;
		...
		<section class="Contener">
            ...
            <div class="subh">
                <center>
					...
					<h2>Issue of Goods (Customer) [<%=dt%>]</h2>
                </center>
            </div>
            <div class="data">
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblissuetocust where Invoice_Date = '"+dt+"'");
							slNo = 1;
							while(rs.next()){
