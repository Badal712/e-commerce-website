...
<%!
	...
	ResultSet rs;
	int slNo;
	String reqN, dt, supID, supN, phNo, mid, gst, proC, proN, cat, pri, purQ, amo, prodC;
		...
		<section class="Contener">
            ...
            <div class="subh">
                <center>
					...
					<h2>Supplier/Company Requisition [<%=prodC%>]</h2>
                </center>
            </div>
            <div class="data">
                <table class="table">
					...
					<%
						...
						try{
							...
							rs = stmt.executeQuery("select * from osp_tblsuppreg where Product_Code = '"+prodC+"'");
							slNo = 1;
							while(rs.next()){
