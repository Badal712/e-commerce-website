...
<html>
	...
	<body>
		<section class="Contener">
			...
			<form name="f1" action="OSP_ReportIssueToRetInvNs.jsp" method="post">
			
				<h2>Issue to Retailer [Invoice Number]</h2>
				<div class="Main">
					<div class="box">
						<div class="input_box">
							<label class="lbl">Invoice Number :</label>
							<select name="cmbInvNo" class="tbox">
								...
								<%
									...
									try{
										...
										while(rs.next()){
											invN = rs.getString("Invoice_Number");
