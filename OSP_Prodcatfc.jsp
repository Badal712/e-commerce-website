...
<%
	...
	try{
		...
		rsArray = stmtArray.executeQuery("select * from osp_tblprodcat");
		i = 0;
...
<html>
	<head>
		...
		<script language="javascript">
			function goBack() {
				window.location = "OSP_Prodcatc.html"
			}
	...
	<body>
		<section class="Contener">
			...
			<form name="f1" action="OSP_Prodcatfs.jsp" method="post">
							...
							<select name="cmbPCC" class="tbox" onchange="productCat()">
								...
								<%
									...
									try{
										...
										rsPCC = stmt.executeQuery("select * from osp_tblprodcat");
