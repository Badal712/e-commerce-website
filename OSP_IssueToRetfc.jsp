...
<%!
	...
	String invNo, sln, invSln, invDt[], requN[], requD[], retN[], retID[], loc[], cit[], phNum[], emid[], gstNum[], invT[], slNum[], prodId[], prodN[], cate[], price[], issQ[], Amo[], disc[], discP[], gstP[], gstAmo[], netA[];
	String reqNo, reqDt[], retaN[], retaID[], local[], ct[], phNo[], mid[], gstN[], sl[], prID[], prN[], categ[], pr[], pQ[], amount[];
...
<%
	...
	doConnect();
		try{
			...
			rsArray = stmtArray.executeQuery("select * from osp_tblissuetoret");
			i = 0;
...
<html>
	<head>
		...
		function showInvInfo(){
			var jinvDt, jrequN, jrequD, jretN, jretID, jloc, jcit, jphNum, jemid, jgstNum, jinvT, jslNum, jprodId, jprodN, jcate, jprice, jissQ, jAmo, jdisc, jdiscP, jgstP, jgstAmo, jnetA;
				var i, j;
			...
			document.f1.txtretN.value = jretN[k-1];
		...
		<script language="javascript">
			...
			function showReq(){				//Showing Requisition Data
				...
				document.f1.txtretN.value = jretaN[k-1];
		...
		<script language ="javascript">
			function goBack(){
				window.location = "OSP_IssueToRet.jsp"
			}
		</script>
	</head>
	<body>
		<section class="Contener">
			...
			<form name="f1" action="OSP_IssueToRetfs.jsp" method="post">
					...
					<div class="box">
								...
								<select name="cmbInvN" class="tbox" onchange="showInvInfo()">
									...
									<%
										...
										try{
											...
											rsInvNum = stmtInvNum.executeQuery("select * from osp_tblissuetoret");
											while(rsInvNum.next()){
								...
								<select class="tbox" name="cmbReqN" onchange="showReq()">
									...
									<%
										...
										try{
											...
											rsReqN = stmtReqN.executeQuery("select distinct Requisition_Number from osp_tblretreq");
											while(rsReqN.next()){
						...
						<div class="row">
							<div class="input_box">
								...
								<input type="text" class="tbox" name="txtretN" readonly>
							</div>
							<div class="input_box">
								<label class="lbl">Retailer ID:</label>
								<input type="text" class="tbox" name="txtretID" readonly>
							</div>
						</div>
						<div class="row">
							<div class="input_box">
						...
						<div class="row">
							...
							<div class="input_box">
								...
								<input type="text" class="tbox" name="txtIssQ" onblur="showAmo()">
